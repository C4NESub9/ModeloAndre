...
//            LinAlg::Matrix<double> data5 = calculaModeloARXMQE(Input[1], Output[1], -60, 0);
    ...
    QStringList RegioesSaude = RegioesSaudeNE+RegioesSaudeN+RegioesSaudeS+RegioesSaudeSE+RegioesSaudeCO;
